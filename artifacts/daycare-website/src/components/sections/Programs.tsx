  ...
  const programs = [
    {
      ...
      schedule: "Tummy time, sensory play, communication and language activities, gentle routines."
    },
    {
      title: "Sunshine Room",
      age: "2 - 3 Years",
      ...
      schedule: "Story time, outdoor play, arts and crafts, music and movement."
    },
    {
      title: "Rainbow Room",
      age: "3 - 5 Years",
      ...
      description: "Preparing children for school through the EYFS framework by building literacy, numeracy, and social-emotional confidence.",
      schedule: "Circle time, literacy and numeracy centres, and creative expression."
    },
    {
      ...
      description: "Daily after-school support for families who need extra care time after regular school hours.",
      schedule: "From 4:00 PM to 6:00 PM, children receive homework support and care until parents are ready for pickup."
    }
  ];
        ...
        <div className="mb-16">
          <FadeIn>
            ...
            <p className="text-muted-foreground max-w-3xl">
              Learning approaches: Montessori, Play Based, Waldorf, Reggio Emilia, and Academic-Focused.
            </p>
          </FadeIn>
        </div>
